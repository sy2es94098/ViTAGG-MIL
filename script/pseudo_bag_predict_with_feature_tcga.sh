...
DATE=06092023
WEIGHT_PATH='LR_0.0004_BLOSS_1_POS_0_HEAD_4_BLOCK_1_LANDMARK_512_ms_fusion_1_7'
D_WEIGHT_PATH='d_classifier_'$WEIGHT_PATH
A_WEIGHT_PATH='milnet_'$WEIGHT_PATH
AGGR_WEIGHT='weight_tcga_ms_pseudo_bag/'$DATE'/'$A_WEIGHT_PATH'.pth'
D_CLASSIFIER_WEIGHT='weight_tcga_ms_pseudo_bag/'$DATE'/'$D_WEIGHT_PATH'.pth'
mkdir $DATE
