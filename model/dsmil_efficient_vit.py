...
class ViT_1d(nn.Module):
    def __init__(self, *, num_classes, dim, transformer, pool = 'cls'):
        super().__init__()
    ...
    def forward(self, series, c):
        ...
        x = self.to_latent(x)
        return self.mlp_head(x), attn, m_indices[0]
...
class MILNet(nn.Module):
    ...
    def forward(self, x):
        ...
        prediction_bag, A, idx = self.b_classifier(feats, classes)

        return classes, prediction_bag, A, idx
