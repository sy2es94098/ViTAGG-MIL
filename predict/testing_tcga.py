    ...
    for i in range(0, num_bags):
        ...
        with torch.no_grad():
            ...
            if args.average:
                ...
                bag_prediction = np.add(bag_prediction, max_prediction)/2
                print(bag_prediction)
            color = [0, 0, 0]
...
if __name__ == '__main__':
    ...
    state_dict_weights["b_classifier.q.0.weight"] = state_dict_weights["b_classifier.q.weight"]
    state_dict_weights["b_classifier.q.0.bias"] = state_dict_weights["b_classifier.q.bias"]
